package com.gambar.tugasgambar;
...
public class MataActivity extends Activity {
    ...
    public void cekJawaban(View v){
		String  jawabanBenar = "MATA PISAU";
		...
		if (jawabanUser.equals(jawabanBenar)){			
			...
			Intent i = new Intent(getApplicationContext(),MatiActivity.class);
			startActivity(i);
		}
		else{
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.mata, menu);
		return true;
	}
